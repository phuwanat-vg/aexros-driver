...
class Picker(object):
    ...
    def camera_callback(self,data):
        ...
        lower_yellow = np.array([self.hue_l,self.saturation_l,self.lightness_l])
        upper_yellow = np.array([self.hue_h,self.saturation_h,self.lightness_h])
...
def main():
     ...
     color_picker=Picker()
     client = dynamic_reconfigure.client.Client("color_picker_server_node", timeout=30, config_callback=color_picker.cfg_callback)
